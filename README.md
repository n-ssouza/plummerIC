...
2. In the GADGET-2 format, all particles are set to the particle type 'stars'. You can change this by editing [this line of code](https://github.com/n-ssouza/plummerIC/blob/main/ic.py#L151) accordingly.
